...
fn field_descriptors() -> Vec<FieldDescriptorDto> {
    vec![
        ...
        descriptor(
            ...
            "Plugins",
            "Included plugins",
            "Optional allowlist of globally active plugin names.",
            "both",
            "low",
            "string_list",
            true,
        ...
        descriptor(
            ...
            "Plugins",
            "Excluded plugins",
            "Globally active plugin names disabled for this Workspace.",
            "both",
            "low",
            "string_list",
            true,
        ...
        advanced_descriptor(
            ...
            "Plugins",
            "Trust profiles",
            "Required, optional, or digest-only Sigstore verification profiles.",
            "high",
            "json",
            json!({ "default": { "mode": "required" } }),
        ),
        advanced_descriptor(
            "plugins.registries",
            "Plugins",
            "OCI registries",
            "Exact registry, token-service, redirect, authentication, and trust origins.",
            "high",
            "json",
            json!({}),
        ),
        advanced_descriptor(
            ...
            "Plugins",
            "Plugin MCP servers",
            "Explicit per-server enablement, credentials, OAuth, allowlists, and limits.",
            "high",
            "json",
            json!({}),
        ),
