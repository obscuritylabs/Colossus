...
| FLOW-01 | Passing P1 + schedules | strict YAML/hash trust; bounded control flow; waits; idempotent retry; compensation; subworkflows; cancellation; fixed-cadence schedule misfire/trust/restart reconstruction; atomic deterministic schedule dispatch under process kill; worker/embedded routing | P2 webhooks, repository events, and subscriptions |
