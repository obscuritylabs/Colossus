...
| Skills, integrations, MCP, packs, and bundles | extension crates and runtime adapters | [Automate and extend](../extend/index.md) | Validation, confinement, signature, registry, and live-adapter tests |
