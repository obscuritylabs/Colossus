...
description: Durable decisions that explain Colossus boundaries and migration choices.
audience: developer
type: reference
---
...
ADRs record decisions whose context matters after implementation details change. They do
not duplicate current configuration or operator procedures.
