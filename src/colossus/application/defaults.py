    ...
    *,
    ...
    return AgentSpec(
        ...
        instructions=(
            ...
            "decision.* tools. Write decisions as interpreted, future-facing commitments "
            "with intent and applicability, not copied user text; list and update existing "
            "decisions instead of creating duplicates. "
