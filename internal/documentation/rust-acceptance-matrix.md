...
| ACCESS-01 | Passing P0 | four metadata-driven profiles; exact and wildcard tool selection; non-overlapping action overrides; OPA ownership; prerequisite diagnostics; future core/integration/pack inheritance; unclassified and removed-field fail-closed coverage; credential-free effective output | future extension source classes |
