...
#[cfg(feature = "sidecar")]
pub use sidecar::{
    HostSecret, MANAGED_CONFIG_FILENAME, ManagedAccessProfile,
    ManagedChatCompletionsOutputTokenParameter, ManagedFieldOverride, ManagedJournalPayloadMode,
    ...
    NativeSidecarFailure, NativeSidecarStatus, REMOTE_PROVIDER_TIMEOUT_MS, SidecarApplicationGrant,
