...
dependency_required=false
sdk_required=false
desktop_required=false' crates/colossus-cli/src/main.rs
expect_classification 'rust_required=true
docs_required=true
dependency_required=false
sdk_required=false
desktop_required=false' docs/index.md crates/colossus-cli/src/main.rs
expect_classification 'rust_required=true
docs_required=false
...
dependency_required=false
sdk_required=false
desktop_required=true' apps/desktop/src/App.tsx scripts/desktop-dev crates/colossus-sdk/src/lib.rs
expect_classification 'rust_required=true
docs_required=false
dependency_required=false
sdk_required=true
